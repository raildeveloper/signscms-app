...
function getAllDeviceView() {
    $.ajax({
        type: "POST",
        url: "/Admin?format=json&action=getAllData",
...
function submitUploadImg(){
    ...
    var selectedFile = $('#upload').val();

    var formData = new FormData();
    formData.append('device', 'selectedDeviceId');
    formData.append('view', 'selectedViewId');
// Attach file
    ...
    $.ajax({
        ...
        //data: jQuery.param({device: selectedDeviceId, view: selectedViewId}),
        data: formData,
