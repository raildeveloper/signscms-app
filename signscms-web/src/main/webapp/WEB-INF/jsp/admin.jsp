...
<body onload="loadAllDeviceViews()">
...
<div>
    ...
    <div id="allDevices" class="container">
        <h3 class="div_label" style="margin-bottom: 25px;">Upload Image:</h3>
        <div class="row">
            <div class="col-md-11">
                <div class="form-area">
                    <form id="uploadImg" method="post" role="form" class="form-horizontal"
                          action="/uploadView" enctype="multipart/form-data">
                        <br style="clear:both">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="device">Escalator</label>
                            <div class="col-md-6">
                                <div class='input-group'>
                                    <select name="devicePicker" id="device" title="Escalator"
                                            class="selectpicker show-tick" required=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class='input-group'>
                                    <select name="viewPicker" id="view" title="Available Modes" class="selectpicker"
                                            required="">
                                        <option>Select...</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="view">Upload New Image</label>
                            <div class="col-md-6">
                                <div class='input-group'>
                                    <input id="upload" name="file" class="form-control" type="file" placeholder="Upload New Image" accept=".jpg, png">
                                </div>
                            </div>
                        </div>
