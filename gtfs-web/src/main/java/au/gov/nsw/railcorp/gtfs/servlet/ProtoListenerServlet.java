...
public class ProtoListenerServlet implements HttpRequestHandler {
	 ...
	 * contents {@inheritDoc}
	 * 
	 * @see HttpRequestHandler#handleRequest(javax.servlet.http.HttpServletRequest,
	...
	public void handleRequest(HttpServletRequest request,
		...
		try {
			...
			// in.toString());
			// final TripPublishEntityMessage entityMessage =
			// TripPublishEntityMessage.parseFrom(in);
			// As part of Phase 2B - This would be GTFSR Proto Buff message and
			// not Trip Publish message.
			final FeedMessage entityMessage = GtfsRealtime.FeedMessage
					.parseFrom(in);
			final String returnMessage = converter
					.processLoadTripUpdates(entityMessage);
